...
export EMSDK_EXTRA="-sUSE_SDL=2 -sMAXIMUM_MEMORY=4GB -sALLOW_MEMORY_GROWTH=1"
export CFLAGS="$CFLAGS $EMSDK_EXTRA"
export CXXFLAGS="$CXXFLAGS $EMSDK_EXTRA"
export LDFLAGS="$LDFLAGS $EMSDK_EXTRA -sPTHREAD_POOL_SIZE=20 -s EXPORTED_RUNTIME_METHODS=FS,ccall,cwrap -s INITIAL_MEMORY=2013265920 -sMIN_WEBGL_VERSION=2 -sUSE_WEBGL2 -sWASMFS=1 -sFORCE_FILESYSTEM=1"
